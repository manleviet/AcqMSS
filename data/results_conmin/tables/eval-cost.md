...
Learning cost. \textsc{ConMin}(raw,$k{=}1$) sizes/checks/time; \textsc{QuAcq} time+queries. budget/$|B|$ = \texttt{max\_queries}$/|B|$ (busybox $<1$, below $|B|$); a wall-clock-timeout run shows `--` (t(s) is the timeout wall, queries the count reached). Exclude-2COV means.
...
| $KB_{5}$ | 3,047.7 | 1.8 | 1,360.2 | 0.0 | 10,676 | 59,905.0 | 3,568.4 | 296.3 | 36,754.4† | 1,901.0† | -- |
